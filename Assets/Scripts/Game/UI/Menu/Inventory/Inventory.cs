...
public class Inventory : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        for (int i = 0; i < 33; i++)
        {
            ...
            {
                default:
                    AddItem(i, data.InventoryItems[0], 0);
                    break;
                case 25:
                    AddItem(i, data.InventoryItems[25], 0);
                    break;
                case 26:
                    AddItem(i, data.InventoryItems[24], 0);
                    break;
                case 27:
                    AddItem(i, data.InventoryItems[26], 0);
                    break;
                case 28:
                    AddItem(i, data.InventoryItems[30], 0);
                    break;
                case 29:
                    AddItem(i, data.InventoryItems[23], 0);
                    break;
                case 30:
                    AddItem(i, data.InventoryItems[27], 0);
                    break;
                case 31:
                    AddItem(i, data.InventoryItems[28], 0);
                    break;
                case 32:
                    AddItem(i, data.InventoryItems[29], 0);
                    break;
            }
        ...
        {
            int var1 = Random.Range(0, data.InventoryItems.Count - 9);
            AddItem(i, data.InventoryItems[var1], Random.Range(1, data.InventoryItems[var1].Stack));
        }
        UpdateInventory();
        qAddGraphics();
    ...
    public void Update()
    {
        ...
        for (int i = 0; i < items.Count; i++)
        {
            ...
            InventoryItem itemImg = data.InventoryItems[items[i].id];
            ...
            {
                InfoImg.GetComponent<Image>().sprite = data.InventoryItems[0].Img;
    ...
    public void OnCollisionPlayer(Collider2D collision2D)
    {
        ...
        for (int i = 0; i < items.Count; i++)
        {
            ...
            {
                if (items[i].count < data.InventoryItems[id].Stack)
                {
                    items[i].count += 1;
                    break;
                }
                else // новая ячейка
                {
                    for (int e = 0; e < items.Count; e++)
                    {
                        if (items[e].id == 0)
                        {
                            AddItem(e, data.InventoryItems[id], 1);
                            break;
                        }
                    }
                }
            ...
            {
                AddItem(i, data.InventoryItems[id], 1);
                break;
            }
        }
    ...
    public void AddInventoryItem(int id, ItemInventory invItem)
    {
        ...
        items[id].itemGameObj.GetComponent<Image>().sprite = data.InventoryItems[invItem.id].Img;
    ...
    public void UpdateInventory()
    {
        for (int i = 0; i < items.Count; i++)
        {
            ...
            items[i].itemGameObj.GetComponent<Image>().sprite = data.InventoryItems[items[i].id].Img;
        }
    }
    ...
    public void SelectObject()
    {
        ...
        if (currentID == -1)
        {
            ...
            if (items[currentID].id != 0 & items[currentID].id < 23)
            {
                ...
                movingObject.gameObject.SetActive(true);
                movingObject.GetComponent<Image>().sprite = data.InventoryItems[currentItem.id].Img;

                RestrictionInventory();
                switch (currentID)
                {
                    default:
                        AddItem(currentID, data.InventoryItems[0], 0);
                        break;
                    case 25:
                        AddItem(currentID, data.InventoryItems[25], 0);
                        break;
                    case 26:
                        AddItem(currentID, data.InventoryItems[24], 0);
                        break;
                    case 27:
                        AddItem(currentID, data.InventoryItems[26], 0);
                        break;
                    case 28:
                        AddItem(currentID, data.InventoryItems[30], 0);
                        break;
                    case 29:
                        AddItem(currentID, data.InventoryItems[23], 0);
                        break;
                    case 30:
                        AddItem(currentID, data.InventoryItems[27], 0);
                        break;
                    case 31:
                        AddItem(currentID, data.InventoryItems[28], 0);
                        break;
                    case 32:
                        AddItem(currentID, data.InventoryItems[29], 0);
                        break;
                }
            }
            else
        ...
        else
        {
            ...
            else
            {
                if (items[selectedId].id != currentItem.id)
                {
                    ...
                    currentItem = CopyInventoryItem(items[selectedId]);
                    movingObject.gameObject.SetActive(true);
                    movingObject.GetComponent<Image>().sprite = data.InventoryItems[items[selectedId].id].Img;
                ...
                {
                    if (items[selectedId].count + currentItem.count <= data.InventoryItems[currentItem.id].Stack)
                    {
                    ...
                    {
                        currentItem.count = items[selectedId].count + currentItem.count - data.InventoryItems[currentItem.id].Stack;
                        items[selectedId].count = data.InventoryItems[currentItem.id].Stack;
                    }
                    UpdateInventory();
                }
            }
    ...
    public void MoveObject()
    {
        ...
        if (!MainInventory.activeSelf) // qqq Тут можно изменить. Проверять не бекграунд, а активен ли сам инвентарь, так будет лучше наверное. 
        {
            ...
            for (int i = 0; i < 33; i++)
            {
                if (items[i].id == 0)
                {
                    AddItem(i, data.InventoryItems[currentItem.id], currentItem.count);
                    UpdateInventory();
                    break;
                }
            }
    ...
    {
        switch (data.InventoryItems[items[28].id].Name)
        {
            case "baton":
                afk = "baton";
                break;
